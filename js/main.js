...
let sigils = document.querySelectorAll('.sigilContainer'),
	...
	pausePlay = document.querySelector('.pause'),
	volOnOff = document.querySelector('.volumeChange'),
...
function vidInit() {
	...
	document.querySelector('p').textContent = `${vidDesc[this.dataset.offset]}`;
  	//debugger;
...
function volumeFunc() {
	let volButton = this.firstElementChild;
...
volOnOff.addEventListener('click',volumeFunc);
